...
- Sign-in troubleshooting: distinguishing a credential problem from a conditional access block from a licensing gap — three very different fixes for one identical user-facing error message
...
- [ ] Microsoft Purview / retention policy fundamentals (relevant to HIPAA retention requirements)
