...
Real production work, documented as I do it. Each section below covers a different domain of enterprise IT and cloud engineering, written up the way I'd walk a hiring manager through it in an interview.

Everything here is sanitized: hostnames, group names, policy names, vendor products, and colleague names are generalized to their functional category. The architecture and reasoning are unchanged from the real implementations.
