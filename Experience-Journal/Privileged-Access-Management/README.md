...
|---|---|
| [Offshore Engineer AppLocker Isolation](../Cloud-Projects/AppLocker-Isolation.md) | Third-party / contractor access scoping. Least privilege enforced at the application-execution layer, not just the network layer |
