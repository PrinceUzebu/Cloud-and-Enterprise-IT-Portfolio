...
| Certification | Issuer | Status | What It Demonstrates |
|---|---|---|---|
| **Microsoft Certified: Azure Administrator Associate (AZ-104)** | Microsoft | ✅ Active | Managing Azure identities, governance, storage, compute, and virtual networks in production |
| **Microsoft Certified: Azure AI Fundamentals (AI-900)** | Microsoft | ✅ Active | Foundational understanding of AI/ML workloads on Azure and responsible AI principles. Now applied directly as sole IT administrator of an [in-house AI platform](../Enterprise-Applications/) |
