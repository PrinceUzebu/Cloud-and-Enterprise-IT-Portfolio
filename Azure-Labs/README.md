...
- [ ] **Resource groups and tagging strategy** for a small multi-environment setup (dev/test/prod), including a naming convention doc. The boring part that matters most at scale
...
- [ ] **Cost Management and budget alerting**, because the fastest way to learn Azure cost behavior is to get an alert you didn't expect
...
1. **What I was trying to learn**, meaning the specific question, not "learn networking"
2. **What I built**, covering architecture and configuration
